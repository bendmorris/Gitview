...
var Gitview = function(args){
	...
	this.createTop = function(obj, container){
		...
		var watchers = dojo.create('a',{
			innerHTML:'<img style="position:relative; top:6px;" src="http://bouchon.github.com/Gitview/bin/repostat_watchers.png"/>'+
		...
		var forks = dojo.create('a',{
			innerHTML:'<img style="position:relative; top:6px;" src="http://bouchon.github.com/Gitview/bin/fork.png"/>'+
