...
window.Gitview = function(args){
	...
	this.createFrame = function(){
		...
		outer.style.cssText = 'box-shadow: 0 0 10px 3px #AAA;position:relative;text-align:left;line-height:15px;padding:5px 5px 30px 5px;'+
			'background:'+this.frameColor+';border-radius:3px;width:'+this.w+';'
		this.domNode.appendChild(outer);
		//inner
		var inner = document.createElement("div");
		inner.style.cssText = 'height:100%;width:'+this.w+';';
	...
	this.createFrameHeader = function(data){
		...
		t.innerHTML = data.followers+' follower';
		...
		v.innerHTML = ' - '+data.public_repos+' repositor';
		...
		x.style.cssText = 'font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:10px;color:#AAA;'
			+'cursor:hand;cursor:pointer;margin-left:5px;position:absolute;top:33px;right:27px';
	...
	this.createTop = function(obj, container){
		...
		repoName.style.cssText = 'color:#4183C4;font-size:24px;font-weight:bold;Helvetica, arial, freesans, clean, sans-serif;letter-spacing:-1px;position:absolute;'
		...
		watchers.innerHTML = '<img style="position:absolute;top:50%;left:-20px;margin-top:-8px;" src="http://bitpshr.info/cdn/star.png"/>'+
		...
		forks.innerHTML = '<img style="position:absolute;top:50%;left:-20px;margin-top:-8px;" src="http://bitpshr.info/cdn/forks.png"/>'+
